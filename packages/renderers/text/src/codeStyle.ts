...
.code-representation-toggle{height:26px;padding:0 9px;border:1px solid var(--code-border);border-radius:999px;background:var(--code-bg);color:var(--code-muted);font:700 11px/1 system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;cursor:pointer}
.code-representation-toggle:hover,.code-representation-toggle:focus-visible{color:var(--code-text);border-color:currentColor;outline:none}
.code-representation-floating{position:sticky;top:8px;z-index:2;display:flex;height:0;justify-content:flex-end;padding-right:12px;pointer-events:none;box-sizing:border-box}
.code-representation-floating .code-representation-toggle{pointer-events:auto}
...
.code-viewer--wrap-long-lines .code-area{width:100%;min-width:0;overflow-x:hidden}
.code-viewer--wrap-long-lines .code-area--wrap-long-lines code{min-width:0;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-word}
.code-area--wrapped-line-numbers{display:block;width:100%;min-width:0;padding:18px 0 28px;overflow-x:hidden}
.code-area--wrapped-line-numbers code.code-lines{display:block;width:100%;min-width:0;padding:0;white-space:normal}
.code-area--wrapped-line-numbers .code-line{display:grid;grid-template-columns:var(--code-line-number-width,5ch) minmax(0,1fr);width:100%;min-width:0;min-height:1.7em;align-items:start;box-sizing:border-box}
.code-area--wrapped-line-numbers .code-line::before{content:attr(data-line-number);position:sticky;left:0;z-index:1;display:block;min-height:1.7em;padding:0 12px 0 16px;border-right:1px solid var(--code-border);background:var(--code-bg);color:var(--code-muted);font:inherit;line-height:1.7;text-align:right;white-space:pre;user-select:none;box-sizing:border-box}
.code-area--wrapped-line-numbers .code-line-content{display:block;min-width:0;padding:0 20px;line-height:1.7;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-word;box-sizing:border-box}
